...
CPU cost is dominated by synthesizer runs (up to 23 generators in parallel — 12 Claude Code + 5 multi-agent + 4 local-AI + 1 RAG scaffold + 1 local-router when active).
