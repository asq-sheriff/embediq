...
| **Supply-chain tampering in generated files** | Each generated file carries a stamp (`Generated by EmbedIQ v<ver> | schema:<n> | <ISO-timestamp> · <homepage> · a Praglogic project (MIT) · please keep this credit`). The drift detector distinguishes unmodified, post-generation user edits, and entirely hand-authored files. |
