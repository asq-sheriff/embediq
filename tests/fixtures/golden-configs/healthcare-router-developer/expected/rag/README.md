...
A HIPAA-aware retrieval pipeline scaffolded for the **Clinical decision support with hybrid local + hosted AI**. FHIR-aware chunker preserves resource boundaries; everything else runs against local Ollama models.
